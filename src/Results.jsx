                ...
                <div className="space-y-6">
                    ...
                    {results.length === 0 ? (
                        ...
                        <div className="mt-5.5 flex justify-center items-center flex-wrap">
                            {results.map((res) => (
                                <div key={res.id} data-aos="fade-up" onChange={(res) => res.card_length} className={`relative cursor-pointer m-3.5 p-5 md:w-xl w-full rounded-4xl border border-white/20 shadow-lg backdrop-blur-md duration-200 transform transition-all hover:scale-[1.02] ${res.color}`}>
